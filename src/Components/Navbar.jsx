...
const Navbar = () => {
  ...
  return (
    ...
    <div className=' absolute bg-transparent flex justify-between items-center h-24 w-full mx-auto px-4 text-white z-50 '>
        ...
        <div className={nav ? 'fixed left-0 top-0  md:w-[30%] w-[40%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-300' : 'fixed left-[-100%]'}>
        
            <img src={logo} alt='logo' className='max-w-[100px]  m-4'/>

            <ul className='uppercase p-4'>
                <li className='p-4 border-b border-gray-600'><Link to= '#1' smooth> Home </Link></li>
                <li className='p-4 border-b border-gray-600'><Link to= '#2' smooth> About </Link></li>
                <li className='p-4 border-b border-gray-600'><Link to= '#3' smooth> Projects </Link></li>
                <li className='p-4 border-b border-gray-600'><Link to= '#1' smooth> Resume </Link></li>
                <li className='p-4 border-b border-gray-600'><Link to= '#4' smooth> Contact </Link></li>
            </ul>
        </div>
    </div>
    </BrowserRouter>
